...
<title>pusboks | <?= $judul; ?></title> 
<!-- Custom fonts for this template--> 
 <link rel="icon" type="image/png" href="<?= base_url('assets/'); ?>/img/pb.jpg">
...
<link href="<?= base_url('assets/'); ?>css/sb-admin-2.min.css" rel="stylesheet"> 
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/js/all.min.js" crossorigin="anonymous"></script></head> 
