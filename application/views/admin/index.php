      ...
      <div class="card border-left-danger shadow h-100 py-2 bg-primary">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-white text-uppercase mb-1">Jumlah Pengunjung</div>
  ...
  <div class="row">
    <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
      <div class="page-header">
        <span class="text-primary mt-2 "><i class="fas fa-users"></i>  Data User</span>
        <a class="text-danger float-right" href="<?php echo base_url('user/data_user'); ?>"><i class="fas fa-search"></i>Tampilkan </a>
      </div>
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
      <div class="page-header">
        <span class="text-warning mt-2"><i  class="fas fa-book"></i> Data Buku</span>
        <a class="float-right" href="<?= base_url('buku'); ?>"><i class="fas fa-search text-primary"></i> Tampilkan</a>
      </div>
